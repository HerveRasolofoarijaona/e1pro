...
router.get('/devis/u/:id_user', devisCtrlr.allDevisForUser); // afficher les devis li�s � cet utilisateur
router.get('/devis/u/:id_user/:id_devis', devisCtrlr.allDevisForUser);
router.get('/devis/:id_devis', devisCtrlr.detailsDevis); // afficher le devis d�taill�
router.get('/devis/:id_devis/status', devisCtrlr.detailsDevis); // page render pour le route du bas 
router.put('/devis/:id_devis', devisCtrlr.returnDevis); // retourner la d�cision de l'entreprise, g�re les boutons Accepter, refuser, negocier
router.delete('/devis/u/:id_user/:id_devis', devisCtrlr.deleteDevis); // supprimer le devis

// router.put('/devis/u/:id_user', demandsCtrlr.updateDevis); // pour mettre � jour si Devis accepter ou non
